...
import { useFuel } from "@/modules/fuel/hooks/use-fuel";
import { FuelStats } from "@/modules/fuel/components/fuel-stats";
import { FuelTable } from "@/modules/fuel/components/fuel-table";
import { FuelFilters } from "@/modules/fuel/components/fuel-filters";
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <PageHeader
        ...
        subtitle="Track diesel/petrol requests, meter readings, and bill completions."
        actions={
          <>
            ...
            <ExportMenu
              ...
              onExportPdf={() => {}}
            />
            <Link href="/dashboard/vehicle-fuel/create"
      ...
      <RegisterTableShell title="Fuel Register" totalCount={requests.length}>
        {loading ? (
          <div className="py-20 text-center text-[var(--app-muted)]">Loading fuel records...</div>
        ) : (
          <FuelTable 
            requests={requests} 
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to delete ${selectedIds.length} selected fuel requests?`}
