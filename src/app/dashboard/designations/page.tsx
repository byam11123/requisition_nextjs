          ...
          <div>
            ...
            <select
              ...
              onChange={(event) =>
                setForm((current) => ({
                  ...current,
                  defaultCustomRoleKey: event.target.value,
                }))
              }
              className={inputClassName}
            >
  ...
  return (
    <div className="animate-fade-in-up space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Designations</h1>
          <p className="mt-1 text-sm text-slate-400">
            Keep job titles clean and reusable across your organization user records.
          </p>
        </div>
        <button
          onClick={() => {
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-rose-500/20 px-3 py-2 text-sm text-rose-300 transition-colors hover:bg-rose-500/10"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
